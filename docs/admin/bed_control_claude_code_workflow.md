...
| 2026-04-26 | `codex/6f-nursing-necessity-strategy` | 過去1年分析の看護必要度トレンドに、6F（内科・ペイン科）実データ版ストラテジーボードを追加。必要度IIの不足を患者日数・件数/月へ換算し、月間ミックス案と今日見る順番へ集約 | py_compile / nursing necessity targeted pytest / smoke test / Playwright E2E |
