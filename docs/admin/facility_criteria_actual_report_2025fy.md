...
| **予定外入院割合※** rolling 3ヶ月（5F、2026-01〜03） | ─（参考値） | **54.4%** | ─ |
| **予定外入院割合※** rolling 3ヶ月（6F、2026-01〜03） | ─（参考値） | **60.1%** | ─ |
...
- **予定外入院割合** — 5F 53.1% / 6F 61.1%（2 値分類の粗い指標）。制度上の「救急搬送後（15% 以上）」に厳密相当する値は **現データからは算出できない**（2026-07 頃に純実データで確定）
...
|------|--------------|------------:|-------------:|-------------------:|
| 5F | 〜2026-03 | 217 | 118 | **54.38%** |
| 6F | 〜2026-03 | 258 | 155 | **60.08%** |
...
- 予定外入院率 5F **53.1%** / 6F **61.1%**（2 値分類の粗い指標）
