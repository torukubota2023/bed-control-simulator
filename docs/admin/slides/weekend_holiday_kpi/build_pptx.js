...
// =============================================================================
{
  ...
  // 制度上の「救急搬送後（救急車搬送+下り搬送）」厳密値は再分類後に確定。
...
// =============================================================================
{
  ...
  const qas1 = [
    ...
    },
    {
      ...
      a: "LOS・85+ 比率は安全マージンを持って達成。予定外入院率 5F 53.1% / 6F 61.1%（2 値分類のため制度上の救急搬送後厳密値は精査中だが、基準 15% 達成見込み）、85+ 27.3%、推定 LOS 5F 16.5 / 6F 15.6 日（緩和後 21 日に対し 4-5 日の余裕）。救急搬送後厳密値は事務データ再分類後に確定。",
    },
    {
