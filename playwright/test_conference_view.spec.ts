...
// =============================================================================
// 退院調整（カンファ資料タブ）E2E テスト (test_conference_view)
// Phase 1 情報階層リデザイン（2026-04-18）以降、旧「🏥 多職種退院調整カンファ」
// は「🏥 退院調整」セクション配下の「🏥 カンファ資料」タブに統合されている。
//
// 検証対象:
//   - サイドバーメニューのセクション「🏥 退院調整」選択
...
test.describe('ベッドコントロール E2E — 退院調整', () => {
  ...
  // ---------------------------------------------------------------------------
  test('サイドバーから「退院調整」を選択できる', async ({ page }) => {
