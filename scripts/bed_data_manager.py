...
# 2026年度改定 地域包括医療病棟入院料1（入院料1: 一般病棟非併設）
# 全国平均患者構成（イ45%/ロ35%/ハ20%）加重平均 ≈ 3,280点
# + リハ・栄養・口腔連携加算 + 物価対応料(49点)
DEFAULT_REVENUE_PARAMS = {
    "phase_a_revenue": 33800,  # A群(急性期1-5日) 基本3,280点+リハ加算2(50点)+物価対応(49点)=3,379点≈33,800円
    "phase_a_cost": 29000,     # 検査・処置・初期治療・看護集中
    "phase_b_revenue": 34400,  # B群(回復期6-14日) 基本3,280点+リハ加算1(110点)+物価対応(49点)=3,439点≈34,400円
    "phase_b_cost": 14000,     # リハビリ主体・急性期コスト減
    "phase_c_revenue": 33800,  # C群(退院準備期15日-) 基本3,280点+リハ加算2(50点)+物価対応(49点)=3,379点≈33,800円
