#!/usr/bin/env python3
"""
hospital_app_development_guide_v3.md → Word(.docx) 変換スクリプト

Markdownファイルを読み込み、構造化されたWordドキュメントを生成する。
出力先: docs/admin/hospital_app_development_guide_v3.docx
"""
...
OUTPUT_PATH = os.path.join(PROJECT_DIR, "docs", "admin", "hospital_app_development_guide_v3.docx")
